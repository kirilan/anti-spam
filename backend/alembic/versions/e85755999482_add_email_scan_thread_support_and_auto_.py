...
down_revision: Union[str, None] = 'asow3ktmv44e'
...
def upgrade() -> None:
    ...
    op.add_column('deletion_requests', sa.Column('source', sa.String(), nullable=False, server_default='manual'))
    op.add_column('email_scans', sa.Column('gmail_thread_id', sa.String(), nullable=True))
    op.add_column('email_scans', sa.Column('email_direction', sa.String(), nullable=False, server_default='received'))
    op.create_index(op.f('ix_email_scans_gmail_thread_id'), 'email_scans', ['gmail_thread_id'], unique=False)
